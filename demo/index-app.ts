...
export class IndexApp extends HTMLElement {
      ...
      render(
        html`
          ...
          <h1>
            ...
            chart for <strong>modern website</strong>. That's it.
          </h1>
          ...
          <footer>
            <span
              >Made with ${kissWinkHeart} by
              <a href="https://twitter.com/AdrienForward"
                >@adrienforward</a
              ></span
            >
          </footer>
